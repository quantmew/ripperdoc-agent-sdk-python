"""Ripperdoc SDK Client for interacting with Ripperdoc Code."""
...
from .types import RipperdocAgentOptions, HookEvent, HookMatcher, Message, ResultMessage


class RipperdocSDKClient:
    """
    Client for bidirectional, interactive conversations with Ripperdoc Code.
    ...
    When to use RipperdocSDKClient:
    - Building chat interfaces or conversational UIs
    - Interactive debugging or exploration sessions
    - Multi-turn conversations with context
    - When you need to react to Ripperdoc's responses
    ...
    See examples/streaming_mode.py for full examples of RipperdocSDKClient in
    different scenarios.

    Caveat: As of v0.0.20, you cannot use a RipperdocSDKClient instance across
    ...
    def __init__(
        self,
        options: RipperdocAgentOptions | None = None,
        transport: Transport | None = None,
    ):
        """Initialize Ripperdoc SDK client."""
        if options is None:
        ...
        os.environ["RIPPERDOC_CODE_ENTRYPOINT"] = "sdk-py-client"
    ...
    async def connect(
        ...
        """Connect to Ripperdoc with a prompt or message stream."""
        ...
        # Calculate initialize timeout from RIPPERDOC_CODE_STREAM_CLOSE_TIMEOUT env var if set
        # RIPPERDOC_CODE_STREAM_CLOSE_TIMEOUT is in milliseconds, convert to seconds
        initialize_timeout_ms = int(
            os.environ.get("RIPPERDOC_CODE_STREAM_CLOSE_TIMEOUT", "60000")
        )
        ...
        self._query = Query(
            ...
            is_streaming_mode=True,  # RipperdocSDKClient always uses streaming mode
    ...
    async def receive_messages(self) -> AsyncIterator[Message]:
        """Receive all messages from Ripperdoc."""
        if not self._query:
    ...
    async def set_model(self, model: str | None = None) -> None:
        ...
        Args:
            model: The model to use, or None to use default. Examples:
                - 'ripperdoc-sonnet-4-5'
                - 'ripperdoc-opus-4-1-20250805'
                - 'ripperdoc-opus-4-20250514'
        ...
        Example:
            ...
            async with RipperdocSDKClient() as client:
                ...
                await client.set_model('ripperdoc-sonnet-4-5')
    ...
    async def get_server_info(self) -> dict[str, Any] | None:
        ...
        Returns initialization information from the Ripperdoc Code server including:
    ...
    async def receive_response(self) -> AsyncIterator[Message]:
        """
        Receive messages from Ripperdoc until and including a ResultMessage.
