...
class RipperdocSDKError(Exception):
    """Base exception for all Ripperdoc SDK errors."""


class CLIConnectionError(RipperdocSDKError):
    """Raised when unable to connect to Ripperdoc Code."""


class CLINotFoundError(CLIConnectionError):
    """Raised when Ripperdoc Code is not found or not installed."""

    def __init__(
        self, message: str = "Ripperdoc Code not found", cli_path: str | None = None
    ):
        if cli_path:
