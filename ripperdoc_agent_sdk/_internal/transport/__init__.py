...
class Transport(ABC):
    ...
    (e.g., remote Ripperdoc Code connections). The Ripperdoc Code team may change or
    or remove this abstract class in any future release. Custom implementations
    must be updated to match interface changes.

    This is a low-level transport interface that handles raw I/O with the Ripperdoc
