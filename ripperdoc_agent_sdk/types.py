"""Type definitions for Ripperdoc SDK."""
...
class SyncHookJSONOutput(TypedDict):
    ...
    feedback to Ripperdoc.

    Common Control Fields:
        continue_: Whether Ripperdoc should proceed after hook execution (default: True).
    ...
    Decision Fields:
        ...
        reason: Feedback message for Ripperdoc about the decision.
...
class SandboxSettings(TypedDict, total=False):
    ...
    This controls how Ripperdoc Code sandboxes bash commands for filesystem
...
class RipperdocAgentOptions:
    """Query options for Ripperdoc SDK."""
    ...
    # using `RipperdocSDKClient.rewind_files()`.
