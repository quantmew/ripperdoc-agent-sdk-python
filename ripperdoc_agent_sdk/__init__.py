...
from .client import RipperdocSDKClient
...
def tool(
    ...
    Args:
        name: Unique identifier for the tool. This is what Ripperdoc will use
            to reference the tool in function calls.
        description: Human-readable description of what the tool does.
            This helps Ripperdoc understand when to use the tool.
...
def create_sdk_mcp_server(
    ...
    Args:
        ...
        tools: List of SdkMcpTool instances created with the @tool decorator.
            These are the functions that Ripperdoc can call through this server.
