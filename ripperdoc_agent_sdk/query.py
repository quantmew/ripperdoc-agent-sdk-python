"""Query function for one-shot interactions with Ripperdoc Code."""
...
from .types import RipperdocAgentOptions, Message
...
async def query(
    *,
    ...
    """
    Query Ripperdoc Code for one-shot or unidirectional streaming interactions.

    This function is ideal for simple, stateless queries where you don't need
    bidirectional communication or conversation management. For interactive,
    stateful conversations, use RipperdocSDKClient instead.

    Key differences from RipperdocSDKClient:
    ...
    Args:
        prompt: The prompt to send to Ripperdoc. Can be a string for single-shot queries
    ...
    Example - With custom transport:
        ```python
        from ripperdoc_agent_sdk import query, Transport
    ...
    os.environ["RIPPERDOC_CODE_ENTRYPOINT"] = "sdk-py"
