"""Tests for RipperdocSDKClient streaming functionality and query() with async iterables."""
...
class TestRipperdocSDKClientStreaming:
    """Test RipperdocSDKClient streaming functionality."""
    ...
    def test_auto_connect_with_context_manager(self):
        ...
        async def _test():
            with patch(
                "ripperdoc_agent_sdk._internal.transport.subprocess_cli.SubprocessCLITransport"
    ...
    def test_connect_with_string_prompt(self):
        ...
        async def _test():
            with patch(
                ...
                client = RipperdocSDKClient()
                await client.connect("Hello Ripperdoc")

                # Verify transport was created with string prompt
                call_kwargs = mock_transport_class.call_args.kwargs
                assert call_kwargs["prompt"] == "Hello Ripperdoc"
...
class TestRipperdocSDKClientEdgeCases:
