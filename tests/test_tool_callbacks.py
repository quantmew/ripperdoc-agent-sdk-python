...
class TestRipperdocAgentOptionsIntegration:
    """Test that callbacks work through RipperdocAgentOptions."""
        ...
        async def pre_tool_hook(
            ...
            return {
                "hookSpecificOutput": {
                    ...
                    "additionalContext": "Extra context for Ripperdoc",
                }
            }
