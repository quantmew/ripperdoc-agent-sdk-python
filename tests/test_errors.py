"""Tests for Ripperdoc SDK error handling."""
...
class TestErrorTypes:
    ...
    def test_base_error(self):
        """Test base RipperdocSDKError."""
        error = RipperdocSDKError("Something went wrong")
        assert str(error) == "Something went wrong"
        assert isinstance(error, Exception)

    def test_cli_not_found_error(self):
        """Test CLINotFoundError."""
        error = CLINotFoundError("Ripperdoc Code not found")
        assert isinstance(error, RipperdocSDKError)
        assert "Ripperdoc Code not found" in str(error)
