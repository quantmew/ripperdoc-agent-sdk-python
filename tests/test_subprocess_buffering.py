...
from ripperdoc_agent_sdk._errors import CLIJSONDecodeError
from ripperdoc_agent_sdk._internal.transport.subprocess_cli import (
...
def make_options(**kwargs: object) -> RipperdocAgentOptions:
    """Construct RipperdocAgentOptions with a default CLI path for tests."""
